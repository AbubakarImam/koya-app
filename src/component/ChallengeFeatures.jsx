...
const ChallengeFeatures = () => {
    ...
    return (
        <section className="flex flex-col max-w-6xl mx-auto space-y-4 mb-16">
                ...
                {challenges.map(({ id, img, users, number, text }) => {
                    return (
                        <Link to="/challenge"
                            ...
                            flex flex-col justify-between w-[70%] h-[18rem] mx-auto md:h-full md:w-full 
                        ...
                        >
                            <div className="h-[70%] w-[90%] md:w-full md:h-full mx-auto relative">
                                ...
                                <span className=" bottom-0 md:block absolute md:bottom-[2px] rounded-lg bg-[#010F2A] px-[5px] py-1 text-[10px] text-white">
